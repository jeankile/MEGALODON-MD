...
module.exports = {
    ...
    SESSION_ID: process.env.SESSION_ID || "MEGALODON~MD~MIAQUYzA#owHiLHfl9uPT58t_l6r_SCaCkeabdvtPb4ag4KdebF0",  // Your bot's session ID (keep it secure)
    
    PREFIX: getConfig("PREFIX") || "!",  // Command prefix (e.g., "., / ! * - +")
    
    BOT_NAME: process.env.BOT_NAME || getConfig("BOT_NAME") || "Kelo",  // Bot's display name
